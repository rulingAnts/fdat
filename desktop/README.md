...
- [PLAN.md](./PLAN.md) — architecture, FLEx data mapping, where annotations live, phases, risks, repository plan, and notes on hosting the web app on Cloudflare Pages.
